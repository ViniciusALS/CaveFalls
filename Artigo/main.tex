...
]{biblatex}                     % For ABNT bibliography generation
...
\addto\captionsportuguese{
    ...
    {\hfill LISTA DE ILUSTRAÇÕES \hfill}
}

\addto\captionsportuguese{
    \renewcommand{\listtablename}
    {\hfill LISTA DE TABELAS \hfill}
}
...
\setSubtitle[Game Design Document]
...
\begin{document} 
    ...
    \input{Tex/ParteExterna/Capa.tex} %% Página obrigatória
    
    %%%%%%%% Elementos Pré-Textuais
    
    \input{Tex/Pretexto/Listas.tex}
    ...
    \nocite{*}
    \phantomsection
    \printbibliography[title={\hfill REFERÊNCIAS \hfill}]
